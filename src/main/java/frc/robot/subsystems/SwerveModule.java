...
//  private final SimpleMotorFeedforward m_turnFeedforward = new SimpleMotorFeedforward(1, 0.5);
  ...
  SimpleWidget shuffleCurrentState;
  SimpleWidget shuffleDesiredState;
  ...
  public SwerveModule(
    ...
    //m_turningMotor.setCANTimeout 
    //m_turningMotor.setControlFramePeriodMs
    ...
    m_turningMotor.setControlFramePeriodMs(20);//max is 100
    ...
    //configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true, 60, 65, 0.1));
    ...
    shuffleCurrentState = container.add("CurrentState", "na");
    shuffleDesiredState = container.add("DesiredState", "na");
  }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    shuffleDesiredState.getEntry().setString(desiredState.toString());
    double m_speedMetersPerSecond =
        ModuleConstants.kDrivetoMetersPerSecond * m_driveMotor.getSelectedSensorVelocity();
...
//    stop the code to stop it from moving if the speed is very, very small
    ...
    m_driveMotor.set(driveOutput/6);//12
    m_turningMotor.set(turnOutput/6);//12
  }
  ...
  public void periodic_func() {
    //Shuffleboard. add("--Current State:", );
    shuffleCurrentState.getEntry().setString(this.getState().toString());
  }
